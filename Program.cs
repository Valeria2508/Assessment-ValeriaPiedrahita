...
using Assessment_ValeriaPiedrahita.services;
using DotNetEnv;
...
builder.Services.AddScoped<IPatientRepositories, PatientsServices>();
    ...
    if (context.Request.Path == "/")
    {
        ...
        <html>
            ...
            <body style='font-family: Arial, sans-serif; background-color: #f4f4f4; text-align: center; height: 90%; display: flex; flex-direction: column; justify-content: center; align-items: center;'>
                <h1 style='color: #333; font-size: 36px;'>Welcome to clinica</h1>
